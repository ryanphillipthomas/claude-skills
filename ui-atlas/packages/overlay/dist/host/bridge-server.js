...
import { BRIDGE_METHODS, BridgeRequestSchema, isBridgeMethod, toStructuredError, UiAtlasError, } from '@ui-atlas/protocol';
 ...
 */
export function createBridgeHandler(token, handlers, options = {}) {
