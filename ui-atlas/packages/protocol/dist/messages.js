...
import { BoxSchema, CaptureKindSchema, ElementIdentitySchema, LocatorCandidateSchema, StateNameSchema, ViewportSchema, } from './model.js';
/* -------------------------------------------------------------------------- */
...
export const QUEUE_JOB_STATUSES = ['queued', 'running', 'done', 'failed', 'cancelled'];
