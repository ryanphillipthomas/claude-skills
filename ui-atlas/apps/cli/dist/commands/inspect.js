...
import { flagBoolean, flagNumber, flagString, requireHttpUrl } from '../args.js';
...
`.trim();
export async function runInspect(args, logger) {
    ...
    try {
        ...
        logger.info(`run ${manifest.runId} finished: ${String(counts.captured)} captured, ` +
